...
// 		var tr = "<tr>"
// 		if (data.results[i].value.toString().substring(data.results[i].value.toString().indexOf('.'), data.results[i].value.toString().length) < 2){
// 			data.results[i].value += "0";
// 		}

// 		tr += "<td>" + data.results[i].key + "</td>" + "<td>" + data.results[i].value.toString() + "</td></tr>";
// 		tbody.innerHTML += tr;
// 	}
// });
